...
class ALIF_EI(tf.keras.layers.Layer):
    # base template from October 22nd, 2020 version of LIF_EI

    def __init__(self, units, frac_e, thr, EL, tau, dt, n_refractory, dampening_factor, tau_adaptation, beta, p_ee, p_ei, p_ie, p_ii, mu, sigma, rewiring):
        super().__init__()
        self.units = units
        self.n_excite = int(frac_e * self.units)
        self.n_inhib = self.units - self.n_excite
        ...
        # voltage, refractory, adaptation, previous spikes
