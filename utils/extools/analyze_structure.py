...
def plot_degree_dist_single_experiments():
    ...
    for xdir in experiments:
        ...
        for i in range(4):
            ...
            sns.histplot(data=np.divide(d_in,d_out), binwidth=5, color='blue', label='within e units', stat='density', alpha=0.5, kde=True, edgecolor='white', linewidth=0.5, line_kws=dict(color='black', alpha=0.5, linewidth=1.5))
            ...
            sns.histplot(data=np.divide(d_in,d_out), binwidth=5, color='red', label='within i units', stat='density', alpha=0.5, kde=True, edgecolor='white', linewidth=0.5, line_kws=dict(color='black', alpha=0.5, linewidth=1.5))
