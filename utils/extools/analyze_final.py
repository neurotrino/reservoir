...
def plot_weight_delta_dists(exp_dirs=spec_nointoout_dirs,exp_season='spring'): # just for dual-training for now
    ...
    ax[0].hist(in_trained-in_naive,bins=30,density=True,color='dodgerblue')
    ax[0].hist(in_trained-in_naive,bins=30,density=True,color='darkorange')
    ...
    ax[1].hist(rec_trained_ee-rec_naive_ee,bins=30,alpha=0.7,color='dodgerblue',density=True)
    ax[1].hist(rec_trained_ei-rec_naive_ei,bins=30,alpha=0.7,color='seagreen',density=True)
    ax[1].hist(rec_trained_ie-rec_naive_ie,bins=30,alpha=0.7,color='darkorange',density=True)
    ax[1].hist(rec_trained_ii-rec_naive_ii,bins=30,alpha=0.7,color='orangered',density=True)
    ...
    ax[2].hist(out_trained_e-out_naive_e,bins=30,color='dodgerblue',density=True)
    out_naive_i = out_naive[:,e_end:i_end].flatten()
    out_trained_i = out_trained[:,e_end:i_end].flatten()
    ax[2].hist(out_trained_i-out_naive_i,bins=30,color='darkorange',density=True)
