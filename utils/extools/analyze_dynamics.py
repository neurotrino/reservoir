...
def output_projection(save_name,weighted=False):
    ...
    for exp in recruit_dirs:
        ...
        if os.path.isfile(final_recruit_file):
            ...
            # plot
            ax[0].hist(x=naive_set_degrees/len(naive_set_degrees),bin_size=3,density=True,alpha=0.5,color="red",label="projection units")
            ax[0].hist(x=naive_rest_degrees/len(naive_rest_degrees),bin_size=3,density=True,alpha=0.5,color="blue",label="other units")
            ax[0].legend()
            ...
            ax[1].hist(x=trained_set_degrees/len(trained_set_degrees),bin_size=3,density=True,alpha=0.5,color="red",label="projection units")
            ax[1].hist(x=trained_rest_degrees/len(trained_rest_degrees),bin_size=3,density=True,alpha=0.5,color="blue",label="other units")
            ax[1].legend()
