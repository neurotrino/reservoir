...
def output_projection(save_name,weighted=False):
    ...
    for exp in recruit_dirs:
        ...
        if os.path.isfile(final_recruit_file):
            ...
            # plot
            ax[0].hist(x=naive_set_degrees,bins=30,density=True,alpha=0.5,color="red",label="projection units")
            ax[0].hist(x=naive_rest_degrees,bins=30,density=True,alpha=0.5,color="blue",label="other units")
            ax[0].legend()
            ax[0].set_xlabel('total unweighted degree')
            ax[0].set_ylabel('density')
            ax[0].set_title('naive (epoch 50)')
            ax[1].hist(x=trained_set_degrees,bins=30,density=True,alpha=0.5,color="red",label="projection units")
            ax[1].hist(x=trained_rest_degrees,bins=30,density=True,alpha=0.5,color="blue",label="other units")
            ax[1].legend()
