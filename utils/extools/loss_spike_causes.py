...
def scatter_reasons():
    ...
    ax1.scatter(losses[1:len(losses)],eiratio_in[0:len(eiratio_in)-1])
    ax1.set_xlabel('loss')
    ax1.set_ylabel('input e/i ratio')
    ax2.scatter(losses[1:len(losses)],eiratio_main[0:len(eiratio_main)-1])
    ax2.set_xlabel('loss')
    ax2.set_ylabel('main e/i ratio')
    ax3.scatter(losses[1:len(losses)],recip_main[0:len(recip_main)-1])
    ax3.set_xlabel('loss')
    ax3.set_ylabel('main reciprocity')
    ax4.scatter(losses[1:len(losses)],eiratio_out[0:len(eiratio_out)-1])
    ax4.set_xlabel('loss')
