...
def create_model(seq_len, n_input, n_recurrent):
    ...
    cell = models.ALIF_EI(n_recurrent, frac_e, thr, EL, tau, dt, n_refrac, dampening_factor, tau_adaptation, beta, p_ee, p_ei, p_ie, p_ii, mu, sigma, rewiring)
...
def main():
    ...
    filepath=str(root_path) + "/tf2_testing/test_logging/epoch{epoch:02d}.hdf5",
